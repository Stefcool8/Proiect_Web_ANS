<main class="home">
    ...
    <section class="image-slider">
        ...
        <figure>
            <img src="/public/assets/img/img1.jpg" class="slide-image" alt="first-image">
        </figure>
        <figure>
            <img src="/public/assets/img/photo.png" class="slide-image" alt="second-image">
        </figure>
        <figure>
            <img src="/public/assets/img/img1.jpg" class="slide-image" alt="third-image">
        </figure>
        <figure>
            <img src="/public/assets/img/photo.png" class="slide-image" alt="fourth-image">
        </figure>
        <figure>
            <img src="/public/assets/img/img1.jpg" class="slide-image" alt="fifth-image">
        </figure>
        <figure>
            <img src="/public/assets/img/photo.png" class="slide-image" alt="sixth-image">
        </figure>            
    </section>
</main>