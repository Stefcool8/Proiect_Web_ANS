...
<main class="home">
    <section class="intro">
        <div class="text-area">
            <h2 class="text-area-title">Open source tool for data visualization</h2>
        </div>
        <div class="button-wrapper">
            <a href="/login"><button class="button-special" role="button">Use it now</button></a>
            <a href="https://github.com/Stefcool8/Proiect_Web_ANS" target="_blank"><button class="button-special" role="button">Github</button></a>
        </div>
        <figure class="video">
    ...
    <section class="slideshow">
        ...
        <figure>
            <img src="../assets/img/img1.jpg" class="slide" alt="first-image">
        </figure>
        <figure>
            <img src="../assets/img/photo.png" class="slide" alt="second-image">
        </figure>
        <figure>
            <img src="../assets/img/img1.jpg" class="slide" alt="third-image">
        </figure>
        <figure>
            <img src="../assets/img/photo.png" class="slide" alt="fourth-image">
        </figure>
        <figure>
            <img src="../assets/img/img1.jpg" class="slide" alt="fifth-image">
        </figure>
        <figure>
            <img src="../assets/img/photo.png" class="slide" alt="sixth-image">
        </figure>            
    </section>
</main>
