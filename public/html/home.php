    ...
    <main role="main" class="main-content">
        <section class="intro-section">
            ...
            <div class="cta-button-group">
                ...
                <a href="https://github.com/Stefcool8/Proiect_Web_ANS" target="_blank" class="cta-btn"><span>Github</span></a>
            </div>
        ...
        <section class="about-section">
            <h2>About Us</h2>
            <p>We are a dedicated team committed to transforming the way you visualize and interact with your data. We believe in the power of data and aim to create intuitive tools to make data analysis accessible and enjoyable for everyone.</p>
        </section>
        <section class="testimonial-section">
            <h2>Testimonials</h2>
            <div class="testimonial">
                <p>"This is the best data visualization tool I've ever used. It's user-friendly and makes data analysis a breeze."</p>
                <h3>- John Doe, Data Analyst</h3>
            </div>
            <div class="testimonial">
                <p>"I love how easy it is to manipulate and share my data. This tool has become an essential part of my workflow."</p>
